...
public class ModelBackpackM extends ModelBiped {

    final ModelRenderer bagMain;

    public ModelBackpackM() {
        this(0.0F);
    }

    public ModelBackpackM(float par1) {
        this(par1, 0.0F, 64, 32);
    }

    public ModelBackpackM(float enlargement, float yShift, int textureWidth, int textureHeight) {
        ...
        bagMain.addBox(-3.5F, 0F + yShift, 2F, 7, 9, 4, enlargement);
        setRotation(bagMain, 0F, 0F, 0F);

        ModelRenderer pocketLeft = new ModelRenderer(this, 33, 5);
        pocketLeft.addBox(3.5F, 4F + yShift, 2.5F, 1, 4, 3, enlargement);
        setRotation(pocketLeft, 0F, 0F, 0F);

        ModelRenderer pocketRight = new ModelRenderer(this, 33, 13);
        pocketRight.addBox(-4.5F, 4F + yShift, 2.5F, 1, 4, 3, enlargement);
        setRotation(pocketRight, 0F, 0F, 0F);

        //
        ModelRenderer pocketUpperFront = new ModelRenderer(this, 15, 28);
        pocketUpperFront.addBox(-2F, 1.3F + yShift, 5.8F, 4, 2, 1, enlargement);
        setRotation(pocketUpperFront, 0F, 0F, 0F);

        ModelRenderer pocketFront = new ModelRenderer(this, 15, 27);
        pocketFront.addBox(-2F, 3.7F + yShift, 6.2F, 4, 4, 1, enlargement);
        setRotation(pocketFront, 0F, 0F, 0F);

        ModelRenderer ledgeFront1 = new ModelRenderer(this, 0, 23);
        ledgeFront1.addBox(-3F, 1F + yShift, 5.3F, 6, 7, 1, enlargement);
        ...
        ledgeFront3.addBox(-2F, 7.5F + yShift, 5.3F, 4, 1, 1, enlargement);
